...
namespace CompactExifLib
{
    ...
    public enum ExifTag
    {
        ...
        //?�m?����V(�i�H�w? 90�B180 �� 270 �ת�???��?�M?���x?���Ϯg�A�e���O?���d�ݾ��b?��?��?��?�즹 EXIF ??)
        ...
        //����v?��(�p�G?������v�����A?���w 2�]�^�o�^)(ExifTagType.UShort)
    ...
    public struct GeoCoordinate
    {
        ...
        /// ???��?��??���פ���
        /// </summary>
        /// <param name="Value">??��?�u</param>
        /// <param name="IsLatitude">�O�_�O?��</param>
        /// <returns></returns>
